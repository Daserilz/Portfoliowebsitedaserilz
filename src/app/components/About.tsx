          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Jirapat Suolan (Daserliz) เป็น Game Devoloper มือใหม่ ที่กำลังสนใจการออกแบบและสร้างสรรค์
                เกมที่น่าสนใจและสนุก โดยในหน้า Page นี้เป็นที่เก็บผลงานที่เคยทำมา
              </p>
              <p className="text-gray-600 mb-4">
              ...
              <p className="text-gray-600">
                เป้าหมายคือการสร้างเกมที่ไม่เพียงแค่สนุก แต่ยังมีคุณค่าและสร้างแรงบันดาลใจให้กับผู้เล่น รวมถึงทิ้งตัวตนของผมไว้ในแวดวงนี้ด้วย
              </p>
            </div>
          </div>
